...
export const fastnetmonApi = {
  dashboard: (node?: string) => api.get('/fastnetmon/dashboard', { params: { node } }),
  traffic: (node?: string) => api.get('/fastnetmon/traffic', { params: { node } }),
  hostCounters: (node?: string) => api.get('/fastnetmon/host-counters', { params: { node } }),
  networkCounters: (node?: string) => api.get('/fastnetmon/network-counters', { params: { node } }),
  blackholes: (node?: string) => api.get('/fastnetmon/blackholes', { params: { node: node || 'blackhole' } }),
  addBlackhole: (ip: string, node?: string) => api.put('/fastnetmon/blackhole', { ip }, { params: { node: node || 'blackhole' } }),
  removeBlackhole: (uuid: string, node?: string) => api.delete(`/fastnetmon/blackhole/${uuid}`, { params: { node: node || 'blackhole' } }),
  flowspec: (node?: string) => api.get('/fastnetmon/flowspec', { params: { node } }),
  bgpPeers: (node?: string) => api.get('/fastnetmon/bgp', { params: { node } }),
  hostgroups: (node?: string) => api.get('/fastnetmon/hostgroups', { params: { node } }),
  config: (node?: string) => api.get('/fastnetmon/config', { params: { node } }),
  updateConfig: (key: string, value: string, node?: string) => api.put('/fastnetmon/config', { key, value }, { params: { node } }),
  updateHostgroup: (name: string, key: string, value: string, node?: string) => api.put(`/fastnetmon/hostgroup/${name}`, { key, value }, { params: { node } }),
  addNetwork: (list_name: string, cidr: string, node?: string) => api.put('/fastnetmon/network', { list_name, cidr }, { params: { node } }),
  removeNetwork: (list_name: string, cidr: string, node?: string) => api.delete('/fastnetmon/network', { data: { list_name, cidr }, params: { node } }),
}
